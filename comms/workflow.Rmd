...
```{r}
rbc <- readRDS("../data/rbc/NLDHL_pvol_20170215T1925_6234_full.RDS")
rbc$data$VIR[rbc$data$VIR == 0] <- NA
...
plot(rbc) +
  dark_theme_minimal() +
  geom_sf(fill = "white", data = geojsonsf::geojson_sf("../data/gis/Netherlands.geojson"))
```
