...
nhol_average_ban <- extract(ban, vect(nhol_clut), raw = TRUE) %>% as.data.frame() %>% summarise(avg = mean(focal_mean, na.rm = TRUE))
nhol_average_bsn <- extract(bsn, vect(nhol_clut), raw = TRUE) %>% as.data.frame() %>% summarise(avg = mean(focal_mean, na.rm = TRUE))
```

```{r}
extract(ban_dens, vect(nl_clut), raw = TRUE) %>% as.data.frame() %>% mutate(focal_mean = focal_mean / 11) %>% skim(focal_mean) # summarise(avg = mean(focal_mean, na.rm = TRUE))
extract(bsn_dens, vect(nl_clut), raw = TRUE) %>% as.data.frame() %>% mutate(focal_mean = focal_mean / 11) %>% skim(focal_mean) # summarise(avg = mean(focal_mean, na.rm = TRUE))
```

```{r}
extract(ban, vect(nl_clut), raw = TRUE) %>% as.data.frame() %>% skim(focal_mean) # summarise(avg = mean(focal_mean, na.rm = TRUE))
extract(bsn, vect(nl_clut), raw = TRUE) %>% as.data.frame() %>% skim(focal_mean)
...
print(extract(bsn, vect(nhol_clut), raw = TRUE) %>% skim(focal_mean))
print(extract(ban, vect(nhol_clut), raw = TRUE) %>% skim(focal_mean))
