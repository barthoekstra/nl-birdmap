...
sp %>%
  ...
  geom_hline(data = sp_means, aes(yintercept = mean_prop * 100), linetype = "dashed", color = "black") +
...
```{r}
stack_rbcs <- function(rbcs, props, year_season, odimcode, daytime = "night", threshold_max = 2500, mean_method = "scans", overwrite = FALSE) {
