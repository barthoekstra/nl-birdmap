...
With all that data in place, we can start to compile the figures. The altitude profile figures are in the radar-profiles.Rmd file.

## Figure 3: Migration across candidate sites
...
```
## Figure 3: Overview map of North-Holland
